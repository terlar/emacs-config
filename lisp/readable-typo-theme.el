...
(let ((default-height readable-typo-theme-default-font-height)
  ...
  (custom-theme-set-faces
   ...
   `(markdown-header-face-4 ((t (:height ,level-1-height :slant italic))))
   `(markdown-header-face-5 ((t (:height ,level-1-height :slant italic))))
   `(markdown-header-face-6 ((t (:height ,level-1-height :slant italic))))
