...
(tao-with-color-variables
  ...
  (custom-theme-set-faces
   ...
   `(org-document-info                       ((t (:height 0.85))))
   `(org-document-info-keyword               ((t (:height 0.85))))
   ...
   `(org-block                               ((t (:height 0.85 :weight light))))
   `(org-block-background                    ((t (:height 0.85))))
   `(org-block-begin-line                    ((t (:height 0.85))))
   `(org-block-end-line                      ((t (:height 0.85))))
   `(org-code                                ((t (:height 0.85 :background ,color-3))))
   `(org-formula                             ((t (:height 0.85))))
   `(org-meta-line                           ((t (:height 0.85))))
   `(org-table                               ((t (:height 0.85))))
   ...
   `(markdown-code-face                      ((t (:inherit fixed-pitch :height 0.85 :background ,color-3))))
   `(markdown-hr-face                        ((t (:inherit fixed-pitch :height ,+default-font-height))))
   `(markdown-inline-code-face               ((t (:height 0.85 :background ,color-3))))
   `(markdown-pre-face                       ((t (:inherit fixed-pitch :height 0.85))))
   `(markdown-table-face                     ((t (:inherit fixed-pitch :height 0.85))))
   ...
   `(rst-literal                             ((t (:inherit fixed-pitch :height 0.85 :background ,color-3))))
   ;; shm
