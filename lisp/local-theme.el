...
(tao-with-color-variables
  ...
  (custom-theme-set-faces
   'local
   `(mode-line                               ((t (:family ,my-variable-pitch-font :foreground ,color-12 :background ,color-6))))
   `(mode-line-inactive                      ((t (:family ,my-variable-pitch-font :foreground ,color-9 :background ,color-7))))
