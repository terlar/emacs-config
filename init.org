...
#+BEGIN_SRC emacs-lisp
(eval-and-compile
  (defvar +default-light-theme 'tao-yang
    "Default light theme.")
  (defvar +default-dark-theme 'tao-yin
    "Default dark theme."))
#+END_SRC
...
(use-package coverlay
  ...
  :hook
  (coverlay-minor-mode . +coverlay-setup)
  :custom
...
(use-package apheleia
  ...
  (progn ;; Python
    (cl-pushnew '(black100 . ("black" "-l" "100" "-")) apheleia-formatters :test #'equal))
  (progn ;; Ruby
