...
*** Zoom
    ...
    (use-package zoom-window
      :general
      ("C-c t z" '(zoom-window-zoom :wk "Zoom")))
    #+END_SRC
...
*** smartparens
    ...
    (use-package smartparens
      ...
      (:keymaps
       'global
       "C-c t p" 'smartparens-strict-mode)
      (:keymaps
...
*** quickrun
    ...
    (use-package quickrun
      :general
      ("C-c m q" 'quickrun
       "C-c t q" '(quickrun-autorun-mode :wk "Quickrun")))
    #+END_SRC
    ...
    (use-package editorconfig
      ...
      (defun +ws-butler-editorconfig (props)
        ...
        (if (equal (gethash 'trim_trailing_whitespace props) "true")
          ...
          (ws-butler-mode 0)))
      :config
      (add-hook 'editorconfig-after-apply-functions #'+ws-butler-editorconfig)
      (editorconfig-mode 1))
    #+END_SRC
