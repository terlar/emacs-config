...
** json
   ...
   (use-package json-mode
     :preface
     (defun +json-mode-add-flymake-hook ()
       "Add `flymake-diagnostic-functions' for `json-mode'."
       (cl-pushnew 'flymake-check-jsonlint flymake-diagnostic-functions :test #'equal))
     :hook
     (json-mode . +json-mode-add-flymake-hook))
   #+END_SRC
