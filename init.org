...
(use-package copilot
  ...
  :preface
  (define-global-minor-mode global-copilot-prog-mode copilot-prog-mode copilot-prog-mode
    :group 'copilot)

  (define-minor-mode copilot-prog-mode
    "Toggle copilot for prog-mode buffer."
    :group 'copilot
