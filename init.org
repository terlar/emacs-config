...
(use-package puni
  ...
  :preface
  (defrepeater #'puni-contract-region)
  (defrepeater #'puni-expand-region)
  :hook
  ...
  (:keymaps
   'puni-mode-map
   :prefix prev-prefix
   "SPC" 'puni-contract-region-repeat)
  (:keymaps
   'puni-mode-map
   :prefix next-prefix
   "SPC" 'puni-expand-region-repeat)
  :config
...
(use-package avy
  :ensure t
  :general
  (:prefix nav-prefix "C" 'avy-goto-char-in-line))
#+end_src
...
- Replace defrepeater and general with builtin functionality such as ~defvar-keymap~.
