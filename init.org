...
** Formatting
   ...
   (use-package format-all
     ...
     (:prefix
      ...
      "f" 'format-all-buffer)
     :init
     (put 'format-all-mode 'safe-local-variable 'booleanp))
   #+END_SRC
   ...
   (use-package reformatter
     ...
     (reformatter-define eslint-format
       :program "eslint_d"
       :args '("--stdin" "--fix-to-stdout" "--cache")
       :lighter 'ELF)
     (put 'eslint-format-on-save-mode 'safe-local-variable 'booleanp))
   #+END_SRC
...
**** flymake-eslint
     ...
     (use-package flymake-eslint
       :init
       (put 'flymake-eslint-executable-name 'safe-local-variable 'stringp)
...
** ruby
   ...
   (use-package ruby-mode
     ...
     (defun +ruby-find-file-setup ()
       "Setup `ff-find-other-file' support for `ruby-mode'."
       (setq ff-test-suffixes '("_test" "_spec")
             ff-other-file-alist
             '(("_\\(test\\|spec\\)\\.rb$" ff-test-converter)
               ("\\.rb$" ff-test-converter))
             ff-search-directories
             (append '(".")
                     (ff-test-project-dirs
                      '("app" "lib"
