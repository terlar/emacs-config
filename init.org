...
(use-package consult
  :ensure t
  :preface
  (defun consult-project-root-project ()
  ...
  (setq consult-project-root-function #'consult-project-root-project)
...
(use-package apheleia
  ...
  (progn ;; Nix
    ...
    (cl-pushnew '(nix-mode . nixpkgs-fmt) apheleia-mode-alist :test #'equal))
  (progn ;; Ruby
