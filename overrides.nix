...
in epkgs // {
  ...
  apheleia = trivialBuild rec {
    pname = "apheleia";
    version = "20210207.850";
    src = fetchFromGitHub {
      owner = "raxod502";
      repo = "apheleia";
      rev = "1ee7f3bc793c9d0052a2e4c0f3b5ca077e32ebd9";
      sha256 = "0lm54v688h6718839g25h7gl69ax8fz2jb5vhakri32148j9nylj";
      # date = 2021-02-07T08:50:31-08:00;
    };
  };
