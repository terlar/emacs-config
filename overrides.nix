...
in epkgs // {
  ...
  embark = trivialBuild {
    pname = "embark";
    version = "20201206.1500";
    src = fetchFromGitHub {
      owner = "oantolin";
      repo = "embark";
      rev = "068048eee04570439b2043848114dc0580d592fd";
      sha256 = "0m2cndr82xnipm4wcn83va9lj6scap4rriy9z00sy1d1nvlj7n9l";
      # date = 2020-12-06T15:00:36-06:00;
    };
