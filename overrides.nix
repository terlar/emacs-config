...
in epkgs // {
  ...
  ejira = trivialBuild {
    pname = "ejira";
    version = "20201108.1729";
    src = fetchFromGitHub {
      owner = "nyyManni";
      repo = "ejira";
      rev = "c3f585a248265880da0c9c1c49a00aa3d7b0d00a";
      sha256 = "1j3rbxy6wbabk329c87nf49ypxj8s1l36wwd6ggkry43n18cccyd";
      # date = 2020-11-08T17:29:54+02:00;
    };
  ...
  valign = trivialBuild {
    pname = "valign";
    version = "20201104.1148";
    src = fetchFromGitHub {
      owner = "casouri";
      repo = "valign";
      rev = "4f3eccdf94e0b0d233968e84443003bb3e77453a";
      sha256 = "00k8qghvblapdxrcfh5p71qid9gr89d8l8qdm5ky999phw91c7d9";
      # date = 2020-11-04T11:48:24-05:00;
    };
  };
}
